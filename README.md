...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9qk3lcu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9qk3lcu.containers.anotherwebservice.com/
...
```
git clone git@github.com:happysandhu05/container-9qk3lcu.git
cd container-9qk3lcu
```
...
```
docker attach container-9qk3lcu
```
